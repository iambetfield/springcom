...
export const GET_CART_REQUEST='GET_CART-REQUEST'
export const GET_CART_SUCCESS='GET_CART-SUCCESS'
export const GET_CART_FAILURE='GET_CART-FAILURE'
...
export const UPDATE_CART_ITEM_REQUEST='REMOVE_CART_ITEM_REQUEST'
export const UPDATE_CART_ITEM_SUCCESS='REMOVE_CART_ITEM_SUCCESS'
export const UPDATE_CART_ITEM_FAILURE='REMOVE_CART_ITEM_FAILURE'