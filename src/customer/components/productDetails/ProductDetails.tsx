...
export default function ProductDetails() {
  ...
  if(product){
    console.log("3. Producto:" ,product);
    console.log("3.1. Producto:" ,product.product?.imageUrl);
  }
  ...
  return (
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10 text-start">
          {/* Image gallery */}
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-wrap spaxe-x-5 justify-center">
              {producto.images.map((item) => (
                <div className="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg max-w-[5rem] max-h-[5rem] mt-4 mr-4">
                  <img
                    src={item.src}
                    alt={item.alt}
                    className="h-full w-full object-cover object-center"
          ...
          <div className="lg:col-span-1 max-h-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div className="lg:col-span-2 ">
              ...
              <h2 className="text-sm lg:text-sm text-gray-00 opacity-60 pt-1">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-2">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-50 text-sm">440330 Ratings</p>
                  <p className="ml-3 text-sm font-medium text-ind-600 hover:text-indigo-500">
                    2870 Reviews
                  </p>
                </div>
              </div>
        ...
        <section>
          ...
          <div className="border p-5">
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                <h1 className="text-lg font-semibold pb-1 text-start">
                  Product Ratings
                </h1>
                <div className="flex items-center space-x-3">
                  <Rating readOnly value={4.6} precision={0.5}></Rating>
                  <p className="opacity-50">44949</p>
                </div>
